...
![The Shared files drawer showing a published Markdown artifact grouped by agent.](../../../assets/channel-shared-file.jpg)
...
![A second agent reads the published artifact and replies in the same channel.](../../../assets/channel-handoff-jobs.jpg)
